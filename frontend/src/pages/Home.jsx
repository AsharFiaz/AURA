...
import {
  ...
  Heart, Hash, Flame, Star, Activity, Zap, Sparkles, WifiOff,
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen text-white relative">
      ...
      <div className="mx-auto flex relative">
        ...
        {/* ── Shared sidebar (now has Insights instead of Bookmarks) ─── */}
        <BombasticSidebar />
