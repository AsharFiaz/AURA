...
import {
  Bell, Home as HomeIcon, User as UserIcon,
  Compass, ShoppingBag, Mail, Bookmark, LogOut, Plus, Search,
} from "lucide-react";
          ...
          <div className="flex items-center justify-center px-4 py-16">
            <motion.div className="w-full max-w-md text-center rounded-2xl p-12"
              ...
              <div className="w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-5"
                style={{ background: "linear-gradient(135deg,#f59e0b,#f97316)", boxShadow: "0 0 32px rgba(245,158,11,0.25)" }}>
                <Bell className="w-10 h-10 text-white" />
              </div>

              <h2 className="text-xl font-bold text-white mb-2">Notifications Coming Soon</h2>
