...
import { Bell, Sparkles, Construction } from "lucide-react";
...
const Notifications = () => {
  ...
  return (
    <div className="min-h-screen text-white relative">
      ...
      <MobileTopBar title="Notifications" icon={Bell} />
      ...
      <div className="flex relative">
        ...
        <main className="flex-1 min-w-0">
          ...
          >
            ...
            <h1 className="text-base font-bold bg-gradient-to-r from-white via-amber-200 to-orange-300 bg-clip-text text-transparent">
              Notifications
            </h1>
          </motion.div>
          ...
          <div className="flex items-center justify-center px-4 py-16 min-h-[calc(100vh-200px)]">
            ...
            >
              ...
              >
                Stay tuned. You'll receive notifications for likes,
                <br />
                comments, follows, and more.
              </motion.p>
