...
import {
  Mail, Home as HomeIcon, Bell, User as UserIcon,
  Compass, ShoppingBag, Bookmark, LogOut, Plus, Search,
} from "lucide-react";
        ...
        <main className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-center px-4 py-16">
            <motion.div className="w-full max-w-md text-center rounded-2xl p-12"
              ...
              <h2 className="text-xl font-bold text-white mb-2">Messages Coming Soon</h2>
              <p className="text-slate-500 text-sm leading-relaxed mb-8">
                Direct messaging is under development. You'll be able to connect with other users soon!
              </p>
